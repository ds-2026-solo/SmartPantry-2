...
4. Abrir el PR contra `main`, completar la plantilla, incluir `Closes #N` y solicitar revisión a `@ds-2026-solo/reviewers`.
...
`https://github.com/ds-2026-solo/SmartPantry-2/compare/main...feature/<numero-issue>-<descripcion-corta>?expand=1`
